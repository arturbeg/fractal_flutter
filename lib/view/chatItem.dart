...
class ChatItem extends StatelessWidget {
  ...
  ChatItem(
      {this.chatDocument, this.isSubchat = false, this.parentMessageSnapshot});
      ...
      onTap: () {
        ...
        if (isSubchat) {
          ...
          Navigator.of(context).push(new MaterialPageRoute(builder: (context) {
            ...
            // return new ChatScreenAlternative("something", "https://img.etimg.com/thumb/msid-65594785,width-300,imgsize-178128,resizemode-4/laliga.jpg");
          }));
        }
      },
    );
